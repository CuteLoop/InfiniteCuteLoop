...
Here we reason from the graph. Choose an \(x\)-value, mark the point \((x,f(x))\), and sketch the tangent line at that point.
Then compare the steepness (slopes) of those tangent lines.
