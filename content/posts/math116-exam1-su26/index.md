...
- **Hint 1 - Ask yourself:** a question. Before you look at Hint 2, try to answer this question in your own words. It is the same question you should be asking yourself on the real exam.
- **Hint 2 - Concept + Procedure:** confirms the idea Hint 1 was pointing at, then lays out the concrete steps to execute it.
...
<details><summary><strong>Hint 1 - Ask yourself</strong></summary>

Vertical asymptotes happen where the **denominator is zero** (and the numerator is not).
</details>

<details><summary><strong>Hint 2 - Concept + Procedure</strong></summary>
